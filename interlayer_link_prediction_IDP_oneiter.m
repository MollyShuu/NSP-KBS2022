function [output_args] = interlayer_link_prediction_IDP_oneiter(lay1_linklist,filename_lay2,filename_lay1_2_rela,theknown_rate,krIntval,thereptime)
%This is a simple version of IDP which predict interlayer links
%by only one iteration. The complete version of IDP can be
%found in https://github.com/dingxiao2021/SOIDP/tree/main/SOIDP
precesionN=30;
...
for experi_times=1:1:repetitiontimes
    ...
    for known_rate=theknown_rate
        ...
        for testlabel=known_rate*100
            ...
            lay1_times_lay2_1=lay1_unkno_kno_spmat_list1*lay2_kno_unkno_spmat_list;
            lay1_times_lay2_2=lay1_unkno_kno_spmat_list*lay2_kno_unkno_spmat_list1;
            lay1_times_lay2=lay1_times_lay2_1+lay1_times_lay2_2;
